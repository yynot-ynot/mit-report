export const SummonerConfig = {
  ...
  "Radiant Aegis": {
    ...
    icon_url: "https://lds-img.finalfantasyxiv.com/d/926e42e9a30e357e4214c95427cd1dd1592974c5.png",
    job: "Arcanist",
    job_icon_url: "https://lds-img.finalfantasyxiv.com/promo/h/k/_3v-EDzckpsEC39oe0t4A8pLJk.png",
    level: 2,
    type: "Ability",
    ...
    range: 30,
    radius: 0,
    tooltip: "Creates a barrier around you that absorbs damage totaling 20% of your maximum HP.\nDuration: 30s\n\n※This action cannot be assigned to a hotbar.",
    potency: [],
    effects: [],
    conditions: [
      "※This action cannot be assigned to a hotbar.",
